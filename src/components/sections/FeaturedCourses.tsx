    ...
    <section id="services" className="bg-surface py-20 md:py-28">
      <div className="container-site">
        <ScrollReveal>
          <SectionHeading
            title="Our services"
            subtitle="Everything you need to secure your place at a top UK university — all under one roof."
            align="center"
          />
        </ScrollReveal>
        ...
        <div className="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {SERVICES.map((service, i) => (
            <ScrollReveal key={service.id} delay={i * 100}>
              <article className="group flex h-full flex-col rounded-3xl bg-white p-8 shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
